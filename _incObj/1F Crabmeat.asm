...
Crab_Main:	; Routine 0
		...
		move.w	#ArtNem_Crabmeat,obGfx(a0)
...
@waittofire:
		subq.b	#1,obCrabTimeDelay(a0) ; subtract 1 from time delay
		bpl.s	@dontmove
		tst.b	obRender(a0)
		bpl.s	@movecrab
		bchg	#1,obCrabMode(a0)
		bne.s	@fire

	@movecrab:
		addq.b	#2,ob2ndRout(a0)
		move.b	#127,obCrabTimeDelay(a0) ; set time delay to approx 2 seconds
...
@walkonfloor:
		subq.b	#1,obCrabTimeDelay(a0)
		bmi.s	loc_966E
		bsr.w	SpeedToPos
		bchg	#0,obCrabMode(a0)
		bne.s	loc_9654
		move.w	obX(a0),d3
		addi.w	#$10,d3
		btst	#0,obStatus(a0)
