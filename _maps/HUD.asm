...
@allyellow:	spriteHeader
	spritePiece	0, -$80, 4, 2, 0, 0, 0, 1, 1		; SCOR
	spritePiece	$20, -$80, 4, 2, $18, 0, 0, 1, 1	; E
	spritePiece	$40, -$80, 4, 2, $20, 0, 0, 1, 1	; Score #
	spritePiece	0, -$70, 4, 2, $10, 0, 0, 1, 1		; TIME
	spritePiece	$28, -$70, 4, 2, $28, 0, 0, 1, 1	; X:XX
	spritePiece	0, -$60, 4, 2, 8, 0, 0, 1, 1		; RING
	spritePiece	$20, -$60, 1, 2, 0, 0, 0, 1, 1		; S
	spritePiece	$30, -$60, 3, 2, $30, 0, 0, 1, 1	; # of rings
...
@allyellow_h:	spriteHeader
	...
	spritePiece	$20, -$80, 4, 2, $18, 0, 0, 1, 1	; E
	spritePiece	$40, -$80, 4, 2, $20, 0, 0, 1, 1	; Score #
	spritePiece	0, -$70, 4, 2, 8, 0, 0, 1, 1		; RING
	spritePiece	$20, -$70, 1, 2, 0, 0, 0, 1, 1		; S
	spritePiece	$30, -$70, 3, 2, $30, 0, 0, 1, 1	; # of rings
	spritePiece	0, -$60, 4, 2, $10, 0, 0, 1, 1		; TIME
	spritePiece	$28, -$60, 4, 2, $28, 0, 0, 1, 1	; X:XX
	spritePiece	0, $40, 2, 2, $10A, 0, 0, 0, 1		; Life Icon
	spritePiece	$10, $40, 4, 2, $10E, 0, 0, 1, 1	; Name and Lives #
@allyellow_h_End
	even
