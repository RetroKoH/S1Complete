...
@ship:	spriteHeader
	spritePiece	-$1C, -$14, 1, 2, $A, 0, 0, 1, 0
	spritePiece	$C, -$14, 2, 2, $C, 0, 0, 1, 0
	spritePiece	-$1C, -4, 4, 3, $10, 0, 0, 1, 0   ; last 4 palettes was 1
...
@flame1:	spriteHeader
	spritePiece	$22, 4, 2, 2, $2D, 0, 0, 1, 0
@flame1_End

@flame2:	spriteHeader
	spritePiece	$22, 4, 2, 2, $31, 0, 0, 1, 0
@flame2_End
