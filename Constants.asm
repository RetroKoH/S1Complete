...
; NEW GLOBAL Animation IDs - To make easier the usage of animations across all 7 characters
; (Sonic, Tails, Knuckles, Amy, Mighty, Ray, Metal)
aniID_Null:			equ 0		; Null animation
aniID_Walk:			equ 1		; Walking animation
aniID_Run:			equ 2		; Running animation
aniID_Dash:			equ 3		; Dashing animation
